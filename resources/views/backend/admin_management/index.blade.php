...
@section('content')
    ...
    <div class="pt-3 admin-table-css">
        ...
        <div class="d-flex">
            <div class="col-6">
                <a href="{{ route('admin.admin-user.create') }}" class="btn btn-outline-primary"> <i
                        class="fa fa-plus-circle"></i> Add Admin Users</a>

            </div>

            <div class="col-6 text-right">
                <a href="{{ route('admin.admin-user.create') }}" class="btn btn-outline-danger"> <i
    ...
    <script>
        $(document).ready(function() {
           var table =  $('#admin-user').DataTable({
                "processing": true,
                "serverSide": true,
                "ajax": "admin-user/datatables/server",
                "columns": [{
                        data: "id",
                        name: "id"
                    },
