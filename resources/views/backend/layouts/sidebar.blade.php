    ...
    <div class="scrollbar-sidebar">
        <div class="app-sidebar__inner">
            <ul class="vertical-nav-menu">
                ...
                <li>
                    <a href="" class="@yield('users-management')">
                        <i class="metismenu-icon pe-7s-users"></i> Users Management
                        <i class="metismenu-state-icon pe-7s-angle-down caret-left"></i>
                    </a>
                    <ul>
                        <a href="{{ route('admin.user.index') }}" class="@yield('users')">
                            <i class="metismenu-icon pe-7s-users"></i> Users
                        </a>
                        <a href="{{ route('admin.wallet.index') }}" class="@yield('users-wallet')">
                            <i class="metismenu-icon pe-7s-wallet"></i> Wallet
                        </a>
                    </ul>
                </li>
            </ul>
